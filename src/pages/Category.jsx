...
import Pagination from '../component/pagecategory/pagination';
...
const articleData = [
  // Halaman 1
  {
    id: 1,
    category: "Sport",
    thumbnail: "public/image/boat.jpg",
    title: "Opening Day Of Boating Season, Seattle WA",
    excerpt:
      "Of Course The Right Sound Is Very Wordy, And Where There Is Make. These Are Basic, Today Is...",
  ...
  },
  {
    id: 6,
    category: "Automotive",
    thumbnail: "public/image/bluesupercar.jpg",
  ...
  },
  {
    id: 10,
    category: "Design",
    thumbnail: "public/image/retrosetup.jpg",
    title: "Typography Can Make Or Break Your Design...",
    excerpt:
      "One Of The Most Important Skills You Can Learn As A Designer Is How To Choose Type. This Is...",
    author: { name: "Robert", avatar: "public/image/louis.jpg" },
    date: "July 14, 2022",
  },
  {
    id: 11,
    category: "Travel",
    thumbnail: "public/image/surfing.jpg",
  ...
  },
  {
    id: 12,
    category: "Cooking",
    thumbnail: "public/image/cook.jpg",
    title: "Lasagna Is But A Pasta Cake",
    excerpt:
      "Re-Envision The Description Of A Common Food From A Different Perspective — It Is... Pasta Cake...",
    author: { name: "Jon Kantner", avatar: "public/image/jon.jpg" },
    date: "July 14, 2022",
  },
  // Halaman 2
  {
    ...
    category: "Sport",
    thumbnail: "public/image/boat.jpg",
    title: "Another Great Day for Boating Season",
    excerpt: "The weather was perfect for another adventure on the water...",
    author: { name: "James", avatar: "public/image/james.jpg" },
    date: "August 25, 2021",
  },
];
      ...
      <div className="max-w-screen-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {currentArticles.map((article) => (
            <div
              key={article.id}
              className="bg-gray-100 rounded-lg shadow-md overflow-hidden flex flex-col hover:shadow-xl transition-shadow duration-350"
            >
              {/* Gambar Artikel */}
